...
# used colors till now  :: accent , RdYlBu
sc = ax.scatter(filterd_df['longitude'], filterd_df['latitude'], c=filterd_df[productKey], cmap='RdYlBu', transform=ccrs.PlateCarree(), s=1)
